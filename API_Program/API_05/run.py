...
from API_Program.API_05.test_cases import run_01_register #具体到模块
from API_Program.API_05.test_cases import run_02_login
from API_Program.API_05.test_cases import run_03_recharge
from API_Program.API_05.test_cases import run_04_withdraw
from API_Program.API_05.test_cases import run_05_addloan
from API_Program.API_05.test_cases import run_06_invest
class RunTest:
    '''生成测试报告'''
    def run_test(self):
