...
from API_Program.API_03_1.common import run_01_register #具体到模块
from API_Program.API_03_1.common import run_02_login
from API_Program.API_03_1.common import run_03_recharge
from API_Program.API_03_1.common import run_04_withdraw
from API_Program.API_03_1.common import run_05_bidloan
class RunTest:
    '''生成测试报告'''
    def run_test(self):
        ...
        suite.addTest(loader.loadTestsFromModule(run_05_bidloan))
        # 执行用例
