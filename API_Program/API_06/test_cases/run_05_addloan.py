...
from API_Program.API_06.common.do_excel import DoExcel
from API_Program.API_06.common.log_test import MyLog
from API_Program.API_06.common.http_request import HttpRequest
from API_Program.API_06.common import project_path
from API_Program.API_06.common.get_data import GetData
from API_Program.API_06.common.do_sql import DoSql
from API_Program.API_06.common import get_data
# 测试数据
...
class RunCase(unittest.TestCase):
    ...
    def test_case(self,case):
        ...
        if case['Sql'] != None:
            ...
            # get_data里不存在的属性值可以直接用setattr
            setattr(GetData,'normal_loan_id',str(loan_id))#将新的loanid赋值给loan_id
        # 进行审核到4状态，替换loan_id  #请求之前替换
        # 调用正则函数替换mobilephone,pwd,memberid,
