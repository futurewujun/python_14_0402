...
# file1=open('log.txt','w+',encoding='utf-8')
file2=open('log.txt','r+',encoding='utf-8')
# res=file2.read(5)  # 读取5个
# print(res)
# res1=file2.readline()   # 按行读
# print(res1)
# for i in range(1,10):   # 读取第三行-先将每一行读出来，再将第三行打印出来
#     res2 = file2.readline()
#     if i == 3:
#         print(res2)
file2.write('hello')
...
#w+ 读写
# a 追加 append- 只写  file存在的话直接追加在后面 ，不清空， 如果file不存在 新建一个再写
...
# 第一个参数 你要移动多少个偏移量 第二个参数 相对于谁去移动 --- 一般只支持相对头部的移动
#0 头部 1  当前位置  2 最末尾
# res=file.read()
# print("res:",res)
